...
#define COOLTIME_SHOOT		(FRAMETIME * 200)
#define COOLTIME_AOE		(FRAMETIME * 300)
#define COOLTIME_SHIELD		(FRAMETIME * 400)
#define COOLTIME_RETURN		(FRAMETIME * 1800)
#define CASTINGTIME_RETURN	(FRAMETIME * 100)
#define ACTIVETIME_SHIELD	(FRAMETIME * 150)
